  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-400 text-white hover:bg-blue-500 transition-colors"
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-500 text-white hover:bg-gray-600 transition-colors"
