    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex flex-col scroll-smooth">
      ...
      <main className={`flex-1 scroll-smooth relative ${className}`}>
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-primary-50/20 via-transparent to-transparent animate-gradientShift" style={{ animationDelay: '2s' }}></div>
        </div>
        {children}
      </main>
...
// Advanced Scroll Controls Component
